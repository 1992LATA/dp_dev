...
const DocumentServiceTypeTable = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get('http://nhtridevsrv.nht.gov.jm:8777/api/v1/GetAllDocumentTypesFull');
...
export default DocumentServiceTypeTable;
